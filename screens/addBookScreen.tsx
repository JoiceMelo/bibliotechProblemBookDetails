    ...
    const handleCreateBook = async () => {
        if (title && author && year && edition && pages && isbn && description && status) {
            ...
            try {
                ...
                const updatedCollection = updatedCollections.find(c => c.title === collectionTitle);

                navigation.navigate('DetailsCollectionScreen', { title: updatedCollection.title, description: updatedCollection.description, books: updatedCollection.books });
            } catch (error) {
